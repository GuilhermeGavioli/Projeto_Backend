...
async function fetchFourSimilarProducts(category) {
  const res = await fetch(
    `${BASE_URL_PATH_AUTH}acharprodutoporcategoria/${4}/${category}`,
    {
      method: "GET",
      headers: {
        "Content-type": "application/json",
...
function createProductCard(item) {
  ...
  cardFirst.setAttribute(
    "src",
    `${BASE_URL_PATH}file_system/product/${item.product_image}`
  );
  ...
  if (cardIsOrganic == 0)
    cardIsOrganic.innerHTML =
      '<i class="fa-solid fa-check" style="margin:0;"></i> organico';
  else
    cardIsOrganic.innerHTML =
      '<i class="fa-solid fa-x" style="margin:0;"></i> organico';
...
async function deleteComment(ratting_id) {
  const res = await fetch(
    `${BASE_URL_PATH_AUTH}deletaravaliacao/${ratting_id}`,
    {
      method: "DELETE",
      headers: {
        "Content-type": "application/json",
...
async function createCommentElement(comment, userid) {
  ...
  if (userid == comment.user_id) {
    ...
    thrashContainer.addEventListener("click", () =>
      deleteComment(comment.ratting_id)
    );
  }
...
async function handleCommentStarsAllocation(container, rating) {
  ...
  if (starNumber == 1) {
    container.innerHTML =
      '<i class="fa-solid fa-heart"></i><i class="fa-regular fa-heart"></i><i class="fa-regular fa-heart"></i><i class="fa-regular fa-heart"></i><i class="fa-regular fa-heart"></i>';
  } else if (starNumber == 2) {
    container.innerHTML =
      '<i class="fa-solid fa-heart"></i><i class="fa-solid fa-heart"></i><i class="fa-regular fa-heart"></i><i class="fa-regular fa-heart"></i><i class="fa-regular fa-heart"></i>';
  } else if (starNumber == 3) {
    container.innerHTML =
      '<i class="fa-solid fa-heart"></i><i class="fa-solid fa-heart"></i><i class="fa-solid fa-heart"></i><i class="fa-regular fa-heart"></i><i class="fa-regular fa-heart"></i>';
  } else if (starNumber == 4) {
    container.innerHTML =
      '<i class="fa-solid fa-heart"></i><i class="fa-solid fa-heart"></i><i class="fa-solid fa-heart"></i><i class="fa-solid fa-heart"></i><i class="fa-regular fa-heart"></i>';
    ...
    container.innerHTML =
      '<i class="fa-regular fa-heart"></i><i class="fa-regular fa-heart"></i><i class="fa-regular fa-heart"></i><i class="fa-regular fa-heart"></i><i class="fa-regular fa-heart"></i>';
  }
}
...
function handleAverage(parentElement, number) {
  if (!number) {
    parentElement.innerHTML =
      '<i class="fa-regular fa-heart" style="margin:0;"></i><i class="fa-regular fa-heart" style="margin:0;"></i><i class="fa-regular fa-heart" style="margin:0;"></i><i class="fa-regular fa-heart" style="margin:0;"></i><i class="fa-regular fa-heart" style="margin:0;"></i>';
  }
  if (number == 1) {
    parentElement.innerHTML =
      '<i class="fa-solid fa-heart" style="margin:0;"></i><i class="fa-regular fa-heart" style="margin:0;"></i><i class="fa-regular fa-heart" style="margin:0;"></i><i class="fa-regular fa-heart" style="margin:0;"></i><i class="fa-regular fa-heart" style="margin:0;"></i>';
  }
  if (number == 2) {
    parentElement.innerHTML =
      '<i class="fa-solid fa-heart" style="margin:0;"></i><i class="fa-solid fa-heart" style="margin:0;"></i><i class="fa-regular fa-heart" style="margin:0;"></i><i class="fa-regular fa-heart" style="margin:0;"></i><i class="fa-regular fa-heart" style="margin:0;"></i>';
  }
  if (number == 3) {
    parentElement.innerHTML =
      '<i class="fa-solid fa-heart" style="margin:0;"></i><i class="fa-solid fa-heart" style="margin:0;"></i><i class="fa-solid fa-heart" style="margin:0;"></i><i class="fa-regular fa-heart" style="margin:0;"></i><i class="fa-regular fa-heart" style="margin:0;"></i>';
  }
  if (number == 4) {
    parentElement.innerHTML =
      '<i class="fa-solid fa-heart" style="margin:0;"></i><i class="fa-solid fa-heart" style="margin:0;"></i><i class="fa-solid fa-heart" style="margin:0;"></i><i class="fa-solid fa-heart" style="margin:0;"></i><i class="fa-regular fa-heart" style="margin:0;"></i>';
  }
  if (number == 5) {
    parentElement.innerHTML =
      '<i class="fa-solid fa-heart" style="margin:0;"></i><i class="fa-solid fa-heart" style="margin:0;"></i><i class="fa-solid fa-heart" style="margin:0;"></i><i class="fa-solid fa-heart" style="margin:0;"></i><i class="fa-solid fa-heart" style="margin:0;"></i>';
  }
}
...
function handleCreateCommentStarsChange(starNumber) {
  const starsContainer = document.querySelector(
    ".create-comment-stars-container"
  );
  ...
  if (starNumber == 1) {
    starsContainer.innerHTML =
      '<i class="fa-solid fa-heart" id="star1"></i><i class="fa-regular fa-heart" id="star2"></i><i class="fa-regular fa-heart" id="star3"></i><i class="fa-regular fa-heart" id="star4"></i><i class="fa-regular fa-heart" id="star5"></i>';
  } else if (starNumber == 2) {
    starsContainer.innerHTML =
      '<i class="fa-solid fa-heart" id="star1"></i><i class="fa-solid fa-heart" id="star2"></i><i class="fa-regular fa-heart" id="star3"></i><i class="fa-regular fa-heart" id="star4"></i><i class="fa-regular fa-heart" id="star5"></i>';
  } else if (starNumber == 3) {
    starsContainer.innerHTML =
      '<i class="fa-solid fa-heart" id="star1"></i><i class="fa-solid fa-heart" id="star2"></i><i class="fa-solid fa-heart" id="star3"></i><i class="fa-regular fa-heart" id="star4"></i><i class="fa-regular fa-heart" id="star5"></i>';
  } else if (starNumber == 4) {
    starsContainer.innerHTML =
      '<i class="fa-solid fa-heart" id="star1"></i><i class="fa-solid fa-heart" id="star2"></i><i class="fa-solid fa-heart" id="star3"></i><i class="fa-solid fa-heart" id="star4"></i><i class="fa-regular fa-heart" id="star5"></i>';
  } else if (starNumber == 5) {
    starsContainer.innerHTML =
      '<i class="fa-solid fa-heart" id="star1"></i><i class="fa-solid fa-heart" id="star2"></i><i class="fa-solid fa-heart" id="star3"></i><i class="fa-solid fa-heart" id="star4"></i><i class="fa-solid fa-heart" id="star5"></i>';
  }
...
async function loadProductRatings(p_id) {
  ...
  const res = await fetch(
    `${BASE_URL_PATH_AUTH}acharavaliacoes/${p_id}/${commentPack}`,
    {
      method: "GET",
      // body: JSON.stringify({p_id, critic}),
      headers: {
